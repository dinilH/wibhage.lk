                                        ...
                                        <tr>
                                           ...
                                           <td>
                                               <a rel="facebox" href="facebox_modal/updateExaminee.php?id=<?php echo $selExmneRow['exmne_id']; ?>" class="btn btn-sm btn-primary">Update</a>
																																																																																																																																																																																																																																																																																																																																																																															<!---------------PROJECTYCS FUTURE_HOPS FOR WEB DEVELOPMENT CATOGORY. DONOT COPY CODES.IF YOU COPY MY WEBAPP AND HOST AS YOURS,I CAN TAKE LEGAL ACTIONS.SO I TRUST YCS TEAM.ALSO I KNOW VULNARABILITIES OF THIS SITE.USING FOR COMMERCIAL USE MAY BE NOT SAFE-------------->
                                           </td>
                                        </tr>
                                    <?php }
                                }
