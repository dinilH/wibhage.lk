                                               ...
                                               while ($selQuestionRow = $selQuest->fetch(PDO::FETCH_ASSOC)) { ?>
                                                <tr>
                                                        ...
                                                        <td class="text-center">															
                                                         <!--<a rel="facebox" href="facebox_modal/updateQuestion.php?id=<?php echo $selQuestionRow['eqt_id']; ?>" class="btn btn-sm btn-primary">Update</a>    if you want enable it!it works but not working properly somethimes.I think it's a browser issue-->
